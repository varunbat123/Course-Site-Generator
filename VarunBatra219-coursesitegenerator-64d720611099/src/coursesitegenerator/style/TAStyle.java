package coursesitegenerator.style;
...
public class TAStyle extends AppStyleComponent {
    ...
    // CourseInfo
    public static String CLASS_COURSE_BOX = "course_box";
    public static String CLASS_PAGE_BOX = "page_box";
    public static String CLASS_SITE_BOX = "site_box";
    
    
    
    // WE'LL USE THIS FOR ORGANIZING LEFT AND RIGHT CONTROLS
    public static String CLASS_PLAIN_PANE = "plain_pane";
      public static String CLASS_CUSTOM_PANE= "custom_pane";
    public static String CLASS_BRIGHTER_PANE= "brighter_pane";
    ...
    public void initOfficeHoursGridStyle() {
        ...
        TAWorkspace workspaceComponent = (TAWorkspace)app.getWorkspaceComponent();
        workspaceComponent.getCourseInfoBox().getStyleClass().add(CLASS_COURSE_BOX);
        workspaceComponent.getSiteBox().getStyleClass().add(CLASS_SITE_BOX);
        workspaceComponent.getPageBox().getStyleClass().add(CLASS_PAGE_BOX);
